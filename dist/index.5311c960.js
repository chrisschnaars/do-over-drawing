...
})({"6G42X":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4e5dac8afe405db7";
module.bundle.HMR_BUNDLE_ID = "8f96a5105311c960";
"use strict";
...
const renderColorPalette = ()=>{
    ...
    for(let i1 = 0; i1 < BGCOLORS.length; i1++){
        let box = document.createElement('div');
        box.style.backgroundColor = BGCOLORS[i1].hex;
        box.style.width = box.style.height = divSize;
        box.classList.add('bg', 'tile');
        document.querySelector('.bg-colors').appendChild(box);
    }
    for(let i2 = 0; i2 < CRAYONSIZES.length; i2++){
        let box = document.createElement('div');
        box.classList.add('size', 'tile');
        box.style.width = box.style.height = divSize;
        box.innerHTML = CRAYONSIZES[i2].name;
...
const updateColorPalette = (bg, fg, size)=>{
    ...
    for(let i = 0; i < current.length; i++)current[i].classList.remove('active');
    // Set BG color
...
//# sourceMappingURL=index.5311c960.js.map
